...
-- NOTE: These mark harpoon list indexes of the buffers up or down! - Good stuff to have, bind them to <C-,> <C-.>
...
-- local TelescopeHarpoon = {}
--
-- ---@return TelescopeHarpoon
-- function TelescopeHarpoon:new()
