...

{
  ...
  boot.initrd.kernelModules = [ "xe" ]; # NOTE: nixos-hardware specifically adds it, remove on nixos-hardware add
    ...
    (
      let
        ...
        firmware = pkgs.fetchurl {
          ...
          hash = "sha256-NRYkIcKkp/7Ee3ZnxvobufuciJRlUoJp23SUfamhHCA=";
        };
      in
